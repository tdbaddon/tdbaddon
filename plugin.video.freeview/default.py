import urllib,urllib2,re,xbmcplugin,xbmcgui,os,sys,datetime,string,hashlib,net
import plugintools
import xbmcaddon
import liveresolver
import xbmcaddon
...
def CATEGORIES():
	if selfAddon.getSetting('list_all') == 'true':  
		...
		addLink('5* | FilmOn','https://www.filmon.com/tv/5-star',1,logos+'5star.png')
		...
		addLink('Channel 5 | TVPlayer','93',2,logos_tvp+'93.png')
		...
		addLink('E4 | FilmOn','https://www.filmon.com/tv/e4',1,logos+'e4.png')
		addLink('Film4 | FilmOn','https://www.filmon.com/tv/film-4',1,logos+'film4.png')
		...
		if selfAddon.getSetting('four_music') == 'TVPlayer': addLink('4Music','128',2,logos_tvp+'128.png')
		
		#5*
		if selfAddon.getSetting('five_star') == 'FilmOn': addLink('5*','https://www.filmon.com/tv/5-star',1,logos+'5star.png')
		...
		#Box Hits
		if selfAddon.getSetting('box_hits') == 'Direct': addLink('Box Hits','http://llnw.live.btv.simplestream.com/coder9/coder.channels.channel2/hls/4/playlist.m3u8',1,logos_tvp+'158.png')
		...
		#Channel 5
		if selfAddon.getSetting('channel_5') == 'TVPlayer': addLink('Channel 5','93',2,logos_tvp+'93.png')
		...
		#E4
		if selfAddon.getSetting('e4') == 'FilmOn': addLink('E4','https://www.filmon.com/tv/e4',1,logos+'e4.png')
		
		#Film4
		if selfAddon.getSetting('film4') == 'FilmOn': addLink('Film4','https://www.filmon.com/tv/film-4',1,logos+'film4.png')
		...
		#ITVBe
		if selfAddon.getSetting('itvbe') == 'ITV Hub': addLink('ITVBe','http://itvbeliveios-i.akamaihd.net/hls/live/219078/itvlive/ITVBE/master_Main1800.m3u8',1,logos+'itvbe.png')
		if selfAddon.getSetting('itvbe') == 'FilmOn': addLink('ITVBe','http://www.filmon.com/tv/itvbe',1,logos+'itvbe.png')
		...
		#More4
		if selfAddon.getSetting('more4') == 'FilmOn': addLink('More4','https://www.filmon.com/tv/more4',1,logos+'more4.png')
