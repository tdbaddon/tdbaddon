...
class i4movie(Scraper):
    def __init__(self):
        ...
        self.bu = 'http://www.india4movie.net/category/'
        ...
        self.list = {'01Tamil Movies': self.bu + 'tamil-movie-list-2016-online-download/',
                     ...
                     '07Hindi Dubbed Movies': self.bu + 'dubbed-movie/',
                     '08Punjabi Movies': self.bu + 'punjabi-movies-list/',
                     '09Marathi Movies': self.bu + 'marathi/',
                     '10Bengali Movies': self.bu + 'bengali-new/',
                     '11Urdu Movies': self.bu + 'pakistani-movies/',
                     '12[COLOR cyan]Adult Movies[/COLOR]': self.bu + 'adult-new-movie-xxx/',
                     '13[COLOR yellow]** Search **[/COLOR]': self.bu[:-9] + '?s='}
