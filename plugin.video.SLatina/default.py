...
addon = xbmcaddon.Addon('plugin.video.SLatina')
...
SOURCES = [{"title": "SLatina", "url": "https://googledrive.com/host/0B1OWTEhQt6paUXRXbzhKQ0NCWEU", "fanart": "https://copy.com/I4w0mMh3vRYxNjEo","thumbnail": "https://copy.com/ApRRosENeHaO1i8z"}]

# https://copy.com/I4w0mMh3vRYxNjEo
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.SLatina-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(SLatina,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
def getSources():
        if os.path.exists(favorites) == True:
            ...
            if FAV == "[]":
                ...
                addDir('[COLOR red][B]- FAVORITES CHANNEL SLatina [/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
                addDir('','',100,'',FANART,'','','','')
