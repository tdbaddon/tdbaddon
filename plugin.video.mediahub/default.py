...
if action == None:
    from resources.lib.indexers import mediahub
    mediahub.indexer().root()

elif action == 'directory':
    from resources.lib.indexers import mediahub
    mediahub.indexer().get(url)

elif action == 'xdirectory':
    from resources.lib.indexers import mediahub
    mediahub.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import mediahub
    mediahub.indexer().developer()

elif action == 'play':
    from resources.lib.indexers import mediahub
    mediahub.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import mediahub
    mediahub.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import mediahub
    mediahub.indexer().search()

elif action == 'addSearch':
    from resources.lib.indexers import mediahub
    mediahub.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import mediahub
    mediahub.indexer().delSearch()
