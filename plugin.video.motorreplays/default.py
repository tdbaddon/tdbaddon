...
baseurl         = 'http://aleighty.ares-project.com/MotorReplays/base.xml'
...
messagetext     ='http://aleighty.ares-project.com/MotorReplays/info.xml'
...
def GetMenu():
        ...
        url = baseurl
        addDir('[B][COLOR yellow]Latest Updates[/COLOR][/B]',url,10,whatsnewicon,fanarts)
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[B][COLOR yellow]Motor Replays[/COLOR] [COLOR white]Latest Updates[/COLOR][/B]', message)
...
def SEARCH():
	...
	link=open_url('http://aleighty.ares-project.com/MotorReplays/search.xml')
