...
baseurl         = base64.b64decode(b'aHR0cDovL3d3dy5zdHJlYW1hcm15LnVrL01haW4vTWVudS54bWw=')
...
def GetMenu():
        ...
        url = baseurl
        addDir('[B][COLOR lime]S[/COLOR][COLOR white]earch[/COLOR][/B] [B][COLOR lime]S[/COLOR][COLOR white]tream[/COLOR][/B] [B][COLOR lime]A[/COLOR][COLOR white]rmy[/COLOR][/B]',url,5,searchicon,fanarts)
