...
REPO_ICON        = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'resources/art/repos.png'))
...
def MENU():
	...
	Common.addDir("[COLOR orange][B]" + str(total_count) + " Addons Downloaded This Week[/B][/COLOR]",BASEURL,150,ALL_ICON,FANART,description='all')
	...
	Common.addDir("[COLOR orange][B][I]Subscription Based Services (e.g IPTV,VPN,TV GUIDES).[/I][/B][/COLOR]",BASEURL,150,PAID_ICON,FANART,description='paid')
