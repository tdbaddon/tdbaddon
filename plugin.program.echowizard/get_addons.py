...
ICON             = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
XXX_ICON         = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
VIDEO_ICON       = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
TOP_ICON         = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
SUPPORT_ICON     = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
PROGRAM_ICON     = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
PICTURE_ICON     = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
PC_ICON          = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
PAID_ICON        = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
PACKS_ICON       = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
MUSIC_ICON       = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
DEP_ICON         = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
ALL_ICON         = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
UPDATE_ICON      = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
REPO_ICON        = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'installer.png'))
