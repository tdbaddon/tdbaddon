...
if action == None:
    from resources.lib.indexers import eyecandy
    eyecandy.indexer().root()

elif action == 'directory':
    from resources.lib.indexers import eyecandy
    eyecandy.indexer().get(url)

elif action == 'developer':
    from resources.lib.indexers import eyecandy
    eyecandy.indexer().developer()

elif action == 'play':
    from resources.lib.indexers import eyecandy
    eyecandy.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import eyecandy
    eyecandy.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import eyecandy
    eyecandy.indexer().search()

elif action == 'addSearch':
    from resources.lib.indexers import eyecandy
    eyecandy.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import eyecandy
    eyecandy.indexer().delSearch()
