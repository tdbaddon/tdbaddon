...
class indexer:
    def __init__(self):
        ...
        self.cartoons_link = 'http://freecartoons.co'
        self.newcartoons_link = 'http://freecartoons.co'
        self.topcartoons_link = '/tag/series/'
        self.cartoongenres_link = '/genre/%s/'
        self.cartoonsearch_link = '/search-cartoons-movie-by-years/'
