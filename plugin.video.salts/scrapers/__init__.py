...
__all__ = ['scraper', 'proxy', 'local_scraper', 'pw_scraper', 'watchseries_scraper', 'movie25_scraper', 'nitertv_scraper',
           'filmovizjia_scraper', 'icefilms_scraper', 'viooz_scraper', 'filmstreaming_scraper', 'myvideolinks_scraper',
           'filmikz_scraper', 'vidnow4k_proxy', 'downloadtube_scraper', 'iwatch_scraper', 'ororotv_scraper', 'vidics_scraper',
           'ocw_proxy', 'losmovies_scraper', 'movie4k_scraper', 'easynews_scraper', 'moviepool_scraper', 'noobroom_scraper',
           ...
           'moviezone_scraper', 'pftv_scraper', 'flixanity_scraper', 'cmz_scraper', 'movienight_scraper', 'alluc_scraper',
           'afdahorg_scraper', 'xmovies8_scraper', 'moviexk_scraper', 'mintmovies_scraper', 'pubfilm_scraper', 'rlssource_scraper',
           ...
           'sezonlukdizi_scraper', 'daily_scraper', 'movietube_scraper', 'putlocker_scraper', 'yshows_scraper', 'diziay_scraper',
           'furk_scraper', 'hevcbluray_scraper', 'ninemovies_proxy', 'miradetodo_scraper', 'dizipas_scraper', 'xmovies8v2_scraper',
           'moviesplanet_scraper', 'premiumize_scraper', 'tvonline_scraper', 'iflix_proxy', 'farda_scraper', 'watchitvideos_scraper',
           'ddlseries_scraper', 'fmovie_scraper', 'seriescoco_scraper', 'veocube_scraper', 'solar_scraper', 'piratejunkies_scraper',
           'watch5s_scraper', 'rlseries_scraper', 'moviesub_scraper', 'watchepisodes_scraper', 'heydl_scraper', 'vkflix_scraper',
           ...
           'ventures_scraper', 'tvshow_scraper', 'watchinhd_scraper', 'quikr_scraper', 'rlshd_scraper', 'tvhd_scraper', 'seehd_scraper',
           'ol_scraper', 'yabanci_scraper', 'real_scraper', 'movytvy_scraper', 'vumoo_scraper', 'vebup_scraper', 'mvgee_proxy']
