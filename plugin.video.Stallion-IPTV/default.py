...
SOURCES = [{"title": "Stallion-IPTV", "url": "https://googledrive.com/host/0BzqtJBUy3FRTTWRLSWpSWmVhZFk", "fanart": "http://fotos.subefotos.com/a7bdae858177e73eaa0884cb30bd65bbo.jpg","thumbnail": "https://copy.com/YJWxFiccRVQKyI4c"}]

# http://fotos.subefotos.com/a7bdae858177e73eaa0884cb30bd65bbo.jpg
# https://copy.com/YJWxFiccRVQKyI4c
...
def getSources():
        if os.path.exists(favorites) == True:
            ...
            if FAV == "[]":
                ...
                addDir('[COLOR red][B]- FAVORITES CHANNEL Stallion-IPTV [/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
                addDir('','',100,'',FANART,'','','','')
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        if res == 'True':
            ...
            xbmc.executebuiltin("XBMC.Notification(Stallion-IPTV,No IMDB match found ,7000,"+icon+")")
