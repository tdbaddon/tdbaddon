...
try:
    ...
    print 'importing Error. [COLOR lime]You need YouTube-dl Module[/COLOR]'
    xbmc.executebuiltin("XBMC.Notification(Albdroid-IPTV,[COLOR lime]Install YouTube-dl Module[/COLOR] ,10000,"")")
...
def single_YD(url,download=False,dl_info=False,audio=False):
    ...
    if info is None:
        print '[COLOR lime]Failed To Extract[/COLOR]'
        return None    
