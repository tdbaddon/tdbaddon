...
Q1RWQ = base64.b64decode('aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcvTFJCYWZZSlM=')     
addon = xbmcaddon.Addon('plugin.video.The-Music-Source')
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.The-Music-Source-%s]: %s" %(addon_version, string))
