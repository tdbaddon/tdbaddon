...
DEFAULT_HEADER = u'''import resources.lib.libraries.js2py.pyjs, sys
# Redefine builtin objects... Do you have a better idea?
for m in sys.modules.keys():
	if m.startswith('js2py'):
		del sys.modules[m]
del resources.lib.libraries.js2py.pyjs
del resources.lib.libraries.js2py
from resources.lib.libraries.js2py.pyjs import *
# setting scope
...
if __name__=='__main__':
    ...
    def main():
        with codecs.open("esp.js", "r", "utf-8") as f:
            d = f.read()
            r = resources.lib.libraries.js2py.translate_js(d)
            exec r in {}
