...
line1 = "  ------BIENVENIDOS A [COLOR yellow]...MUNDO LATINO...[/COLOR]ESTE ADDON ES GRATIS Y ESTA PROHIBIDA SU VENTA.....[COLOR yellow][B]MUNDO LATINO[/B][/COLOR]'"
...
Base = 'http://miguelloeza.blogspot.com/p/mundo-latino2.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.MundoLatino') #    modificar("el nombre de tu addons")
