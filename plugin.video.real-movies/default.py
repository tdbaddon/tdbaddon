...
baseurl         = 'http://kodimadman.site88.net/addons/real-movies/base.xml'
...
messagetext     = 'http://kodimadman.site88.net/addons/real-movies/info.xml'+'?%d=%s' % (random.randint(1, 10000), random.randint(1, 10000))
...
def SEARCH():
	...
	link=open_url('http://kodimadman.site88.net/addons/real-movies/search.xml')
