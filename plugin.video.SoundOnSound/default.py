# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Sound On Sound Magazine YouTube Videos by Slim
#------------------------------------------------------------
...
addonID = 'plugin.video.SoundOnSound'
addon = Addon(addonID, sys.argv)
local = xbmcaddon.Addon(id=addonID)
icon = local.getAddonInfo('icon')
fanart = local.getAddonInfo('fanart')

YOUTUBE_CHANNEL_ID = "UCFw2zGrdiLLAwbNQra1vtnA"
...
def main_list(params):
    textfile = "http://pastebin.com/raw/LuLhsJua"
