...
def Change_Log():
    if not os.path.exists(Change_Log_Path):
        TextBoxes('[COLORgreen]Update Succesful To V 1.44[/COLOR]','\n\n[COLORorange]CONGRATULATIONS We Are Back/ Youve Updated Successfully[/COLOR]\n\n[COLORblue]VISIT https://www.facebook.com/groups/thepyramidkodi/ for help and advice[/COLOR]\n\n[COLORblue]OR FOLLOW US ON TWITTER @PyramidAddOn[/COLOR]\n\n[COLORred]Please Make Sure You Have Installed From An Official Source[/COLOR]')
...
def SKindex():
    Change_Log()
    addDir('[B][I][COLORwhite]THE PYRAMID FAVOURITES[/B][/I][/COLOR]','[B][I][COLORwhite]THE PYRAMID FAVOURITES[/B][/I][/COLOR]',4,'https://cdn.pixabay.com/photo/2016/03/31/18/34/bookmark-1294473_960_720.png' ,  FANART,'','','','')
...
#                print channel
                ...
                try:
                    if name == '[B][I][COLORgold]YOU ARE IN THE MOVIE ZONE[/B][/I][/COLOR]':
                        ...
                        addDir('[B][I][COLORgold]PYRAMID MOVIE SEARCH[/B][/I][/COLOR]','[B][I][COLORgold]PYRAMID MOVIE SEARCH[/B][/I][/COLOR]',41,'http://tombraiderbuilds.co.uk/Icons/search.jpg' ,  FANART,'','','','')
                    elif linkedUrl=='':
                        addDir(name.encode('utf-8', 'ignore'),url.encode('utf-8'),2,thumbnail,fanArt,desc,genre,date,credits,True)
                    else:
