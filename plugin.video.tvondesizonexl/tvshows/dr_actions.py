...
PREFERRED_DIRECT_PLAY_ORDER = [TVLogy.VIDEO_HOSTING_NAME, Playwire.VIDEO_HOSTING_NAME, LetWatch.VIDEO_HOST_NAME, VideoWeed.VIDEO_HOST_NAME, WatchVideo2US.VIDEO_HOSTING_NAME, CloudEC.VIDEO_HOST_NAME]
