# -*- coding: utf-8 -*-
ZeusStreamVersion = "V1.0.0"
ZeusStreamDate = "12/06/2015 10:00hrs GMT"
...
def GETTVSOURCES(name,url):
    ...
    if rNo>=0:
        ...
        AddDir('[COLOR white]Replay '+name+'[/COLOR]',str(rURL),68,ZeusPNG,background=GetCompile('TVBackground'),isFolder=False)
