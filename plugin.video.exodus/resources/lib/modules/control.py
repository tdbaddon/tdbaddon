...
def has_upgraded():
    old_version = setting('old_version')
...
def announcement():
    ...
    def do_My_TextSplash(msg='', img='https://www.tvaddons.ag/wp-content/uploads/2017/03/tvacolor.png', HowLong=15, resize=False, L=0, T=0, W=1280, H=720, TxtColor='0xFFFFFFFF', Font='font14', BorderWidth=10):  # HowLong in seconds.
        class MyWindowCountDownWithText(xbmcgui.WindowDialog):
            ...
            def __init__(self, msg='', bgArt='', L=0, T=0, W=1280, H=720, TxtColor='0xFFFFFFFF', Font='font14',  BorderWidth=10):
                ...
                image_path = os.path.join(addonPath, 'resources', 'skins', 'Default', 'media', 'DialogBack.png')
