...
print len(iv.decode('hex'))
print "aaa"

#a = AESCipher("number-one")
#print a.decrypt(ct,iv.decode('hex'))





#moje = AESCipher("8179d872e1ecb741".decode("hex"))
#print moje.decrypt(("dfd805cd78db758290b1bb0842ec203e").decode("hex")+base64.b64decode('Mwg2s5i+w4k9Y1Tpw\/7tYczLZot51uyDhjTOu0lqQ7o='))
#print binascii.hexlify(base64.b64decode(ct))
#print (iv+s)
#print binascii.hexlify('number-one')

#ala= "F595891BA0ADF16A632355D10F71416643E8C31BC61ABBCDDA55657449C1935C"
#print(ala.decode("hex"))